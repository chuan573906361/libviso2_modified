...
public:
  ...
  void setCalibration(float f,float cu,float cv,float b);//modified by chuan
  std::vector<int32_t> getInlier(std::vector<Matcher::p_match> &p_matched,std::vector<double> &tr);//modified by chuan
