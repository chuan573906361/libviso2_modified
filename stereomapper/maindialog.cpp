...
//  visualize_thread = new VisualizeThread(ui->modelView);//modified by chuan
...
//      read_thread->setInputDir(input_dir);
      read_thread->setInputDir("/home/chuan/libviso2/2010_03_09_drive_0019");//modified by chuan
//      read_thread->setInputDir("/home/chuan/libviso2/result0");//modified by chuan
      read_thread->start();
    }
...
void MainDialog::newStereoImageArrived(){
  ...
  // elas mode
    ...
    ui->elasImageView->setImage(simg.I1,simg.width,simg.height);//modified by chuan
...
//      stereo_thread->pushBack(simg,ui->subsamplingCheckBox->isChecked());
      stereo_thread->pushBack(simg,false);//modified by chuan
      stereo_thread->start();
//      cout<<"aaaaaaaaaaaa"<<endl;
  ...
  // left full image
    ...
    ui->leftFullImageView->setImage(simg.I1,simg.width,simg.height);//modified by chuan

  // right full image
  } else if (ui->tabWidget->currentIndex()==3) {
    ui->rightFullImageView->setImage(simg.I2,simg.width,simg.height);//modified by chuan
  }
}
...
void MainDialog::newDisparityMapArrived() {
  ...
  if (ui->tabWidget->currentIndex()==0)
  {
    ...
    if (!ui->subsamplingCheckBox->isChecked())//modified by chuan
    if (true)
